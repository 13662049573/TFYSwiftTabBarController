...
class ViewController: UIViewController {
    ...
    public override func viewDidLoad() {
        ...
        let model4 = Model(title: "TFYSwiftTabBarItem 和 UITabBarItem 混合使用", cls: MixTabBarController.classForCoder())
        ...
        self.dataSource = [model1, model2, model3, model4, model5, model6, model7, model8, model9, model10, model11]
