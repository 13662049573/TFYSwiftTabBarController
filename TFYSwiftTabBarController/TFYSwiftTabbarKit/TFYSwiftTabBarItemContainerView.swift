//
//  TFYSwiftTabBarItemContainerView.swift
...
open class TFYSwiftTabBarItemContainerView: UIView {

    /// 是否被选中
    public private(set) var isSelected: Bool = false
    
    /// tabBar
    public internal(set) weak var tabBar: TFYSwiftTabBar?
    ...
    public var badgeView: UIView? {
        set {
            ...
            if let _b = newValue as? TFYSwiftTabBarBadgeView {
    ...
    /// 默认的badgeView
    public private(set) lazy var defaultBadgeView: TFYSwiftTabBarBadgeView = {
...
extension TFYSwiftTabBarItemContainerView {
